...
ggsave("../figures/fig2c_bimodality_max_growth_curve.svg", width = 4, height = 3, bg='transparent')
...
ggsave("../figures/FigS13/growth_NLIM_NREP.svg", width = 4, height = 3, bg='transparent')
...
ggsave(".../figures/FigS13/bimodality_NLIM_NREP.svg", width = 4, height = 3, bg='transparent')
