...
get_bimodality_stat <- function(file_name){
  ...
  output.path <- paste("../figures/figS9/bimodality_replicates_",file_name$name,".svg",sep='')
...
ggsave("../figures/fig2a_bimodality_bar_chart.svg", width = 4, height = 3, bg='transparent')
...
ggsave("../figures/figS11a_bimodality_bar_chart.svg", width = 4, height = 3, bg='transparent')
