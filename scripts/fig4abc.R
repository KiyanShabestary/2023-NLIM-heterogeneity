...
data.cond1 <- read.csv(file = "../source_data/fig4abc/1430_A1_yATP_NLIMPRO.csv") #1hr post-shift
data.cond2 <- read.csv(file = "../source_data/fig4abc/1430_A3_yATP_NLIMGLN.csv")

data.cond1 <- read.csv(file = "../source_data/fig4abc/1530_C2_yATP_NLIMPRO.csv") #2hr post-shift
data.cond2 <- read.csv(file = "../source_data/fig4abc/1530_C4_yATP_NLIMGLN.csv")

data.cond1 <- read.csv(file = "../source_data/fig4abc/1730_E1_yATP_NLIMPRO.csv") #4hr post-shift
data.cond2 <- read.csv(file = "../source_data/fig4abc/1730_E3_yATP_NLIMGLN.csv")

data.cond1 <- read.csv(file = "../source_data/fig4abc/1930_G1_yATP_NLIMPRO.csv") #6hr post-shift
data.cond2 <- read.csv(file = "../source_data/fig4abc/1930_G3_yATP_NLIMGLN.csv")

data.cond1 <- read.csv(file = "../source_data/fig4abc/2130_A1_yATP_NLIMPRO.csv") #8hr post-shift
data.cond2 <- read.csv(file = "../source_data/fig4abc/2130_A3_yATP_NLIMGLN.csv")
...
ggsave("../figures/fig4a_size_2h_ATP_PRO_GLN_rep1.svg", width = 5, height = 5, bg='transparent')

# Plot histogram ATP
plot_hist_2c(data.master,"yATP.H","condition","yATP output (VL2-H/VL1-H)",4.5, 2,c("NLIMGLN","NLIMPRO"))
ggsave("../figures/fig4a_ATP_2h_ATP_PRO_GLN_rep2_4_5.svg", width = 5, height = 5, bg='transparent')
...
ggsave("../figures/fig4a_contour_2h_ATP_PRO_GLN_rep2_ylim_4_5.svg", width = 5, height = 5, bg='transparent')


########### FBP YL2/BL1 ##########

# 4hr post-shift
data.cond1 <- read.csv(file = "../source_data/fig4abc/1650_A9_FBPs1_NLIMPRO.csv") %>% trim_below(10)
data.cond2 <- read.csv(file = "../source_data/fig4abc/1650_A11_FBPs1_NLIMGLN.csv") %>% trim_below(10)

# 6hr post-shift
data.cond1 <- read.csv(file = "../source_data/fig4abc/1850_C9_FBPs1_NLIMPRO.csv") %>% trim_below(10)
data.cond2 <- read.csv(file = "../source_data/fig4abc/1850_C11_FBPs1_NLIMGLN.csv") %>% trim_below(10)

# 8hr post-shift
data.cond1 <- read.csv(file = "../source_data/fig4abc/2050_G9_FBPs1_NLIMPRO.csv") %>% trim_below(13)
data.cond2 <- read.csv(file = "../source_data/fig4abc/2050_G11_FBPs1_NLIMGLN.csv") %>% trim_below(13)
...
data.2h <- read.csv(file = "../source_data/fig4abc/1530_C1_yATP_NLIMPRO.csv") #2h
data.4h <- read.csv(file = "../source_data/fig4abc/1730_E1_yATP_NLIMPRO.csv") #4h
data.6h <- read.csv(file = "../source_data/fig4abc/1930_G1_yATP_NLIMPRO.csv") #6h
data.8h <- read.csv(file = "../source_data/fig4abc/2130_A1_yATP_NLIMPRO.csv") #8h
...
ggsave("../figures/figS16_Rmixmod_ATP_8h_pk_L_I_hard.svg", width = 4, height = 4, bg='transparent')
...
ggsave("../figures/fig4b_ATP_box_plot_Rmixmod_Gaussian_pk_L_I_points.svg", width = 4, height = 2, bg='transparent')
...
data.4h <- read.csv(file = "../source_data/fig4abc/1650_A9_FBPs1_NLIMPRO.csv") %>% trim_below(10) #4h
data.6h <- read.csv(file = "../source_data/fig4abc/1850_C9_FBPs1_NLIMPRO.csv") %>% trim_below(13) #6h
data.8h <- read.csv(file = "../source_data/fig4abc/2050_G9_FBPs1_NLIMPRO.csv") %>% trim_below(13) #8h
...
ggplot(data_plot,aes(y=FBPs1.H, x=timepoints,color=factor(classification), fill=factor(classification))) + 
  #geom_point(position=position_jitterdodge(dodge.width=0.9,jitter.width = 0.7), size=1, alpha=0.1) +
  geom_boxplot(aes(y=FBPs1.H, x=timepoints,color=factor(classification)),colour="black",outlier.colour=NA, position=position_dodge(width=0.9))+
