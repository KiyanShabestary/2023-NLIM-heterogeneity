...
data <- read.xlsx( "../source_data/fig4b/20230112_HO_HLUM_NLIM_aa.xlsx", sheetIndex = 2) %>% 
...
blank <- data$A11
data <- data %>% dplyr::select(-G7,-G8,-G9,-G10,-G11,-A11,-Cycle.Nr.,-Time..s.,-Temp....C.)
...
ggsave("../figures/fig4b_230112_NLIM_max_growth.svg", width = 6, height = 3, bg='transparent') #4/3
